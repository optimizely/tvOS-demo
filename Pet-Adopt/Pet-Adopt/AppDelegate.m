...
- (NSURL *)applicationCachesDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.wangjoshuah.Pet_Adopt" in the application's caches directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Pet_Adopt" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationCachesDirectory] URLByAppendingPathComponent:@"Pet_Adopt.sqlite"];
    NSError *error = nil;
